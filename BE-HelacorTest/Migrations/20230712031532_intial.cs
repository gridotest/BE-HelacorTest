        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                values: new object[,] {{"Empresa 1","AA100CE",55,"CENTRO",new DateTime(2023,03,10),new DateTime(2023,03,13),new DateTime(2023,03,13),"ENTREGADO"},
                                        ...
                                        {"Empresa 23","AB122HG",106,"LITORAL",new DateTime(2023,04,01),new DateTime(2023,04,06),null,"NO_ENTREGADO"},
                                        {"Empresa 24","AB123HG",107,"LITORAL",new DateTime(2023,04,02),new DateTime(2023,04,07),null,"NO_ENTREGADO"},
                                        {"Empresa 25","AB124HG",25,"LITORAL",new DateTime(2023,04,03),new DateTime(2023,04,08),null,"NO_ENTREGADO"},
